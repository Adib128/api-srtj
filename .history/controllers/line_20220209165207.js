...
exports.searchLines = async (req, res, next) => {
  ...
  // Checking if line type sent and adding it to the search Query
  if(req.body.type)
  query.lineType = req.body.type ; 
  // Checking if line number sent and adding it to the search Query
  if(req.body.lineNumber)
  query.lineNumber = req.body.lineNumber ; 

  try {
    // Executing Query ordered by Line number
